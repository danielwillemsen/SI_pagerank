function population = ga_phase1_sort_population(population, fname, mode)
% ga_phase1_sort_population sorts the population by its score, either in ascending or in descending mode.
...
for i = 1:numel(fname)
    if strcmp(fname{i}, 'Q') || strcmp(fname{i}, 'score') || strcmp(fname{i}, 'mutations')
