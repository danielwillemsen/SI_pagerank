%% Script to evaluate the results of the optimization using PageRank for the consensus task
%
% Used in the paper:
...
savedata = 0; % Use 1 to save data. It might overwrite old data!!!
m = 2;
...
filenames = dir([data_read_folder, 'consensus_m',num2str(m),'_*_optim_4000gen.mat']);

%% Evaluate after evolution using simulator
...
for i = 2:numel(filenames)
    ...
    param_sim = { 'type', 'consensus', 'visualize', 0, 'verbose', 1};
...
if savedata
    ...
    save([data_write_folder,'consensus_m',num2str(m),'_results_new_5_10_20.mat']);
end